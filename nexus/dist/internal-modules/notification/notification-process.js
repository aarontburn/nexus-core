                ...
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        localPort.on('message', function (event) {
                            var _a, _b;
                            var _c = event.data, eventType = _c.eventType, data = _c.data;
                            switch (eventType) {
                                case "closed":
                                case "reject": {
                                    (_a = props.rejectAction) === null || _a === void 0 ? void 0 : _a.action();
                                    break;
                                }
                                case "resolve": {
                                    (_b = props.resolveAction) === null || _b === void 0 ? void 0 : _b.action();
                                    break;
                                }
                                default: {
