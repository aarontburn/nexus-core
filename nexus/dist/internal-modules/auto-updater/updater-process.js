...
var AutoUpdaterProcess = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.requestExternal("nexus.Settings", "get-setting", "always_update")];
                    case 1:
                        if ((_a.sent()).body) {
                        ...
                        this.requestExternal("aarontburn.Debug_Console", "addCommandPrefix", {
                            ...
                            executeCommand: function (args) {
                                var SILENT_ARGS = ["-s", "--s", "-silent", "--silent"];
                                if (!args.some(function (element) { return SILENT_ARGS.includes(element); })) {
                                    console.info(_this.version);
                                }
     ...
     */
    AutoUpdaterProcess.prototype.setUpdaterBehavior = function () {
        var _this = this;
        ...
        electron_updater_1.autoUpdater.on('update-available', function (info) {
            ...
            console.info("\n" + out.join("\n") + "\n");
            clearInterval(_this.autoUpdaterInterval); // Kill the auto updater interval since we already know there is one.
        });
        electron_updater_1.autoUpdater.on('update-downloaded', function (event) {
            ...
            clearInterval(_this.autoUpdaterInterval); // At this point, the interval should've been killed but no harm
        });
        ...
        electron_updater_1.autoUpdater.on('error', function (err) {
            ...
            clearInterval(_this.autoUpdaterInterval); // Kill the updater if something breaks
        });
    };
    AutoUpdaterProcess.prototype.startAutoUpdater = function () {
        ...
        this.autoUpdaterInterval = setInterval(function () {
    ...
    AutoUpdaterProcess.prototype.handleExternal = function (source, eventType, data) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, url, moduleID, downloadedSuccess, target, force, moduleID, response, updateInfo, successful;
            var _this = this;
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (!url.startsWith("https://github.com/") || !url.includes("/releases/latest/download/") || !url.endsWith(".zip")) {
                            return [2 /*return*/, { code: nexus_module_builder_1.HTTPStatusCodes.BAD_REQUEST, body: "Invalid link passed; link can only be in the format 'github.com/<owner>/<repo>/releases/latest/download/<module_id>.zip'" }];
                        }
                        moduleID = url.split("/").at(-1).replace(".zip", '');
                        return [4 /*yield*/, this.moduleUpdater.downloadLatest(moduleID, url)];
                    case 2:
                        downloadedSuccess = _d.sent();
                    ...
                    case 3:
                        ...
                        if (!this.context.moduleMap.has(target)) {
                            return [2 /*return*/, { body: "No module with the ID of ".concat(target, " found."), code: nexus_module_builder_1.HTTPStatusCodes.NOT_FOUND }];
                        }
                    ...
                    case 7:
                        ...
                        if (!(force || this.moduleUpdater.compareSemanticVersion(updateInfo.latestVersion, updateInfo.currentVersion) === 1)) return [3 /*break*/, 9];
                    ...
                    case 8:
                        ...
                        _d.label = 9;
                    case 9: return [2 /*return*/, { body: "Successfully updated ".concat(moduleID, " from ").concat(updateInfo.currentVersion, " to ").concat(updateInfo.latestVersion), code: nexus_module_builder_1.HTTPStatusCodes.OK }];
                    case 10:
                        {
