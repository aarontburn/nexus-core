...
var ModuleUpdater = /** @class */ (function () {
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            if (response.code !== nexus_module_builder_1.HTTPStatusCodes.OK) {
                                                console.error("[Nexus Auto Updater] Error when checking for update: ".concat(response.code, " - ").concat(response.body));
                                                return [2 /*return*/];
                                            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.compareSemanticVersion(versionInfo.latestVersion, versionInfo.currentVersion) !== 1) {
                            return [2 /*return*/, {
                                    code: nexus_module_builder_1.HTTPStatusCodes.NO_CONTENT,
                                    body: "No update found for ".concat(moduleID, ". Current: ").concat(versionInfo.currentVersion, " | Remote: ").concat(versionInfo.latestVersion)
                                }];
                        }
                        else {
                            return [2 /*return*/, {
                                    code: nexus_module_builder_1.HTTPStatusCodes.OK,
                                    body: "Update found for ".concat(moduleID, ". Current: ").concat(versionInfo.currentVersion, " | Remote: ").concat(versionInfo.latestVersion)
                                }];
                        }
                        return [2 /*return*/];
                }
    ...
    ModuleUpdater.prototype.getLatestRemoteVersion = function (moduleID) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var moduleInfo, response, releaseData, version, assets, missingFields;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (moduleInfo === undefined) {
                            return [2 /*return*/, {
                                    ...
                                    code: nexus_module_builder_1.HTTPStatusCodes.BAD_REQUEST
                                }];
                        }
                    ...
                    case 2:
                        ...
                        if (!assets || assets.length === 0) {
                            return [2 /*return*/, {
                                    body: "No release assets found for ".concat(moduleID),
                    ...
                    case 3:
                        ...
                        if (moduleInfo["git-latest"] === undefined) {
                            missingFields.push("".concat(moduleID, ".git-latest"));
                        }
                        else {
                            if (moduleInfo["git-latest"]["git-username"] === undefined) {
                                missingFields.push("".concat(moduleID, ".git-latest.git-username"));
                            }
                            if (moduleInfo["git-latest"]["git-repo-name"] === undefined) {
                                missingFields.push("".concat(moduleID, ".git-latest.git-repo-name"));
                            }
                        }
                        return [2 /*return*/, {
                                code: nexus_module_builder_1.HTTPStatusCodes.NOT_IMPLEMENTED,
                                body: "Could not find update version for ".concat(moduleID, ". Missing: ").concat(missingFields.join(", "))
                            }];
                }
            });
        });
