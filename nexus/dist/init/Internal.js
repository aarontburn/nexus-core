...
var PATH = nexus_module_builder_1.StorageHandler.PATH;
var STORAGE_PATH = PATH + "/storage/";
var INTERNAL_PATH = PATH + "/internal/";
var EXTERNAL_MODULES_PATH = PATH + "/external_modules/";
var COMPILED_MODULES_PATH = PATH + "/built/";
...
function getInternalArguments() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createDirectories()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, readInternal()];
                case 2:
                    internal = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.allSettled([
                        ...
                        fs.promises.mkdir(STORAGE_PATH, { recursive: true }),
                        fs.promises.mkdir(EXTERNAL_MODULES_PATH, { recursive: true }),
                        fs.promises.mkdir(COMPILED_MODULES_PATH, { recursive: true }),
                        fs.promises.mkdir(INTERNAL_PATH, { recursive: true }),
                    ])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
...
function readInternal() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    internalFilePath = INTERNAL_PATH + "/internal.json";
