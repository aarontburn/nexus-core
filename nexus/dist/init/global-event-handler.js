            ...
            return __generator(this, function (_f) {
                switch (eventType) {
                    ...
                    case "get-current-module-id": {
                        return [2 /*return*/, { body: (_a = context.displayedModule) === null || _a === void 0 ? void 0 : _a.getID(), code: nexus_module_builder_1.HTTPStatusCodes.OK }];
                    }
                    ...
                    case "open-dev-tools": {
                        ...
                        mode = (_b = data[0]) !== null && _b !== void 0 ? _b : "right";
                    ...
                    case "get-module-icon-path": {
                        target = (_d = data[0]) !== null && _d !== void 0 ? _d : source.getIPCSource();
                        ...
                        return [2 /*return*/, { body: (_e = context.moduleMap.get(target)) === null || _e === void 0 ? void 0 : _e.getIconPath(), code: nexus_module_builder_1.HTTPStatusCodes.OK }];
                    }
                    default: {
